...
public class CommandHandlerImpl implements CommandHandler {
    ...
    @Override
    public String executeCommand(String name, List<String> parameters) throws DuplicateModelException, RaceAlreadyExistsException, NoSetRaceException, InsufficientContestantsException, NonExistantModelException {
        switch (name) {
